...
namespace Bluscream.MoreChatNotifications.Modules {
    public class VirtualDesktopModule : MonoBehaviour {
        private const string VDServerProcessName = "VirtualDesktop.Server";
        private Process virtualDesktopProcess;
        ...
        public void ToggleMonitor() {
            if (monitorRoutine != null) {
                ...
                monitorRoutine = StartCoroutine(MonitorVirtualDesktop());
            }
        }

        private IEnumerator MonitorVirtualDesktop() {
            Enabled = true;
        ...
        private void CheckForVirtualDesktop() {
        ...
        public static class ModuleConfig {
            ...
            public static void InitializeMelonPrefs() {
                ...
                VirtualDesktopInterval = _melonCategory.CreateEntry("VirtualDesktop check interval (s)", 1f,
                    description: $"How many seconds between checks whether {VDServerProcessName}.exe is (still) running");
